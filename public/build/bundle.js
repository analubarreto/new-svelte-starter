    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(h1, "class", "text-2xl");
    			add_location(h1, file$5, 5, 1, 116);
    			attr_dev(main, "class", "flex flex-col items-center");
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$2, 17, 3, 356);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(select, file$2, 15, 1, 258);
    			add_location(div, file$2, 14, 0, 251);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 11, 1, 332);
    			attr_dev(nav, "class", "flex justify-evenly py-5");
    			add_location(nav, file$1, 10, 0, 292);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 22, 1, 565);
    		},
    		m: function mount(target, anchor) {
